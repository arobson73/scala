...
scala ../../vim_colors/src/main/scala/app.scala "Inventory Publisher WaitForRequests WaitForPublisher ProcessRequest Unhandled BookReply" "Transition BookRequest Done PendingRequests" > colors.txt
